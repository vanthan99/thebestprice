...
//    }
    ...
    public ResponseEntity<Object> listRetailerApproveFalse(
            @PageableDefault(sort = "createdAt", direction = Sort.Direction.DESC) Pageable pageable,
            @RequestParam(value = "keyword",required = false) String keyword
    ) {
        return retailerService.pageRetailerByApprove(false, keyword, pageable);
    }
    ...
    public ResponseEntity<Object> listRetailerApproveTrue(
            @PageableDefault(sort = "createdAt", direction = Sort.Direction.DESC) Pageable pageable,
            @RequestParam(value = "keyword",required = false) String keyword
    ) {
        return retailerService.pageRetailerByApprove(true, keyword, pageable);
    }
